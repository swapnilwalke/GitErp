 ...
 */
public class SchoolDaoImplTest extends BaseSchoolTest {
    ...
    /**
     * Test method for {@link com.virtusa.sms.school.dao.schoolDaoImpl#
     * save(com.virtusa.akura.api.dto.School)}.
     *
    ...
    /**
     * Test method for {@link com.virtusa.sms.school.dao.schoolDaoImpl#
     * update(com.virtusa.akura.api.dto.School)}.
     *
     * @throws AkuraAppException - the exception that occurred.
     */
    @Test
    public final void testUpdate() throws AkuraAppException {
        ...
        try {
            ...
            School findSchool = (School) schoolDao.findById(
            School.class, school.getSchoolId());
            assertEquals(newSchool.getContactNo(),
                    findSchool.getContactNo());
        } catch (DataAccessException e) {
            e.printStackTrace();
        }
    }
    ...
    public final void testGetSchoolList() throws AkuraAppException {
        ...
        try {
            School newSchool = schoolDao.save(school);
            assertNotNull(newSchool);
            List<School> schoolList = schoolDao.findAll(School.class);
