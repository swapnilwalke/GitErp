 ...
 */
public class StudentAnnualGradeRankDaoImplTest extends BaseStudentTest {
    ...
    /** Defines StudentClassInfo type object. */
    private StudentClassInfo studentClassInfo1;
    ...
    /** Defines StudentTermMark type object. */
    private StudentTermMark studentTermMark2;
    
    /** Defines StudentTermMark type object. */
    private StudentTermMark studentTermMark3;
    ...
    public final void setUp() throws AkuraAppException {
        ...
        student1.setAdmissionNo("A1123 test 123*");
        student1.setNameWtInitials("I L");
        student1.setLastName("Lolratne ");
        student1.setAddress("Gampaha");
        student1.setFullName("Lol Lolrathne");
        student1.setModifiedTime(new Date());
        student1.setLanguageId(language.getLanguageId());
        student1.setReligionId(religion.getReligionId());
        student1.setTravelId(methodOfTravel.getTravelId());
        student1.setBloodGroupId(bloodGroup.getBloodGroupId());
        student1.setHouseId(house.getHouseId());
        student1.setCityId(city.getCityId());
        student1.setNationalityId(nationality.getNationalityId());
        student1.setGender('M');
        student1.setIsOldBoy(false);
        student1.setDateOfBirth(new Date());
        student1.setAdmissionDate(new Date());
        student1.setFirstSchoolDay(new Date());
        
        student1 = studentDao.save(student1);
        assertNotNull("New Student should not be null " + student1);
        ...
        // Instantiates studentClassInfo object.
        studentClassInfo1 = new StudentClassInfo();
        studentClassInfo1.setStudent(student1);
        studentClassInfo1.setClassGrade(classGrade);
        studentClassInfo1.setModifiedTime(new Date());
        studentClassInfo1.setYear(new Date());
        studentClassInfo1.setCheckMonitor(false);
        
        studentClassInfo1 = studentClassInfoDao.save(studentClassInfo1);
        assertNotNull("New StudentClassInfo should not be null " + studentClassInfo1);
        ...
        // Instantiates StudentTermMark object.
        studentTermMark2 = new StudentTermMark();
        studentTermMark2.setStudentClassInfoId(studentClassInfo1.getStudentClassInfoId());
        studentTermMark2.setGradeSubjectId(gradeSubject.getGradeSubjectId());
        studentTermMark2.setComments("The comment test 1*");
        studentTermMark2.setTermId(term.getTermId());
        studentTermMark2.setModifiedTime(new Date());
        studentTermMark2.setMarks(10);
        
        // Instantiates StudentTermMark object.
        studentTermMark3 = new StudentTermMark();
        studentTermMark3.setStudentClassInfoId(studentClassInfo1.getStudentClassInfoId());
        studentTermMark3.setGradeSubjectId(gradeSubject.getGradeSubjectId());
        studentTermMark3.setComments("The comment test 1*");
        studentTermMark3.setTermId(term1.getTermId());
        studentTermMark3.setModifiedTime(new Date());
        studentTermMark3.setMarks(20);
        
    }
    
    /**
     * Test method for getStudentAnnualGradeRank method in StudentAnnualGradeRankDaoImpl.
     * 
     * @throws AkuraAppException throws if exception occurs
     */
    @Test
    public void testGetStudentAnnualGradeRank() throws AkuraAppException {
        ...
        StudentTermMark newTermMark2 = studentTermMarkDaoRef.save(studentTermMark2);
        StudentTermMark newTermMark3 = studentTermMarkDaoRef.save(studentTermMark3);
        
        final int noOfPrizes = 5;
        List<StudentAnnualGradeRank> list =
                studentAnnualGradeRankDao.getStudentAnnualGradeRank(gradeSubject.getGrade().getGradeId(),
    ...
    public void tearDown() throws AkuraAppException {
        ...
        studentTermMarkDaoRef.delete(studentTermMark2);
        studentTermMarkDaoRef.delete(studentTermMark3);
        
        studentClassInfoDao.delete(studentClassInfo);
        studentClassInfoDao.delete(studentClassInfo1);
