 ...
 */
public class SubjectAverageTermMarksDaoImplTest extends BaseStudentTest {
    ...
    /**
     * Test method for getSubjectAverageTermMarksById method in SubjectAverageTermMarksDaoImpl.
     * 
    ...
    public void testGetSubjectAverageTermMarksById() throws AkuraAppException {
        ...
        SubjectAverageTermMarks subjectAverageTermMarks =
                subjectAverageTermMarksDao.getSubjectAverageTermMarksById(classGrade.getDescription(),
                        DateUtil.getYearFromDate(studentClassInfo.getYear()), gradeSubject.getGradeSubjectId(),
                        term.getDescription());
        assertNotNull(subjectAverageTermMarks);
        assertTrue(subjectAverageTermMarks.getAverage() ==10);
        assertTrue(subjectAverageTermMarks.getTotalMarks() ==10);
