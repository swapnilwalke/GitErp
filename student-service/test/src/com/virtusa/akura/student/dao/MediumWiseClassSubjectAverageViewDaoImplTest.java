...
/**
 * Test class for all the methods in MediumWiseClassSubjectAverageViewDaoImpl.
 */
public class MediumWiseClassSubjectAverageViewDaoImplTest extends BaseStudentTest {
    ...
    public final void setUp() throws AkuraAppException {
        ...
        studyMedium.setStudyMediumName("Sinhala language test");
        studyMedium.setModifiedTime(new Date());
        
        studyMedium = studyMediumDao.save(studyMedium);
        assertNotNull(" language saved to db " + studyMedium);
    ...
    /**
     * This is the test method for findMediumWiseClassSubjectAverage method in
     * MediumWiseClassSubjectAverageViewDaoImpl class.
     * 
     * @throws AkuraAppException throws if exception occur during testing.
     */
    @Test
    public void testFindMediumWiseClassSubjectAverage() throws AkuraAppException {
        ...
        MediumWiseClassSubjectAverageView object =
                mediumWiseClassSubjectAverageViewDao.findMediumWiseClassSubjectAverage(classGrade.getClassGradeId(),
                        DateUtil.getYearFromDate(studentClassInfo.getYear()), gradeSubject.getGradeSubjectId(),
                        term.getDescription(), studyMedium.getStudyMediumId());
     ...
     */
    @Test
    public void testFindStudyMediumsInClass() throws AkuraAppException {
    
        StudentTermMark newTermMark = studentTermMarkDaoRef.save(studentTermMark);
        assertNotNull("Student Term Mark type should not be null " + newTermMark);
        
        List<Integer> studyMediumList =
                mediumWiseClassSubjectAverageViewDao.findStudyMediumsInClass(classGrade.getClassGradeId(),
                        DateUtil.getYearFromDate(studentClassInfo.getYear()), term.getDescription());
        
        assertTrue(studyMediumList.size() > 0);
    }
