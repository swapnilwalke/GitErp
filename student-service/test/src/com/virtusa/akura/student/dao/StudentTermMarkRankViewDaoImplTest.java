 ...
 */
public class StudentTermMarkRankViewDaoImplTest extends BaseStudentTest {
    ...
    /**
     * Test method for getStudentTermMarksRank method in StudentTermMarkRankViewDaoImpl.
     * 
    ...
    public void testGetStudentTermMarksRank() throws AkuraAppException {
        ...
        StudentTermMarksRank studentTermMarksRank =
                studentTermMarkRankViewDao.getStudentTermMarksRank(studentClassInfo.getStudentClassInfoId(),
                        term.getTermId());
