 ...
 */
public class StudentTermMarkViewDaoImplTest extends BaseStudentTest {
    ...
    /**
     * Test method for getTermMarksByTermGradeYear method in StdentTermMarkViewDaoImpl.
     * 
     * @throws AkuraAppException if exception occurs
     */
    @Test
    public void testGetTermMarksByTermGradeYear() throws AkuraAppException {
        ...
        List<StudentTermMarkDTO> list =
                studentMarksViewDao.getTermMarksByTermGradeYear(studentClassInfo.getClassGrade().getClassGradeId(),
                        newTermMark.getTermId(), DateUtil.getYearFromDate(studentClassInfo.getYear()));
        
        assertTrue(list.size() > 0);
    }
    
    /**
     * Test method for getTermMarksByClassInfoIdAndGradeSubject method in StdentTermMarkViewDaoImpl.
     * 
     * @throws AkuraAppException if exception occurs
     */
    @Test
    public void testGetTermMarksByClassInfoIdAndGradeSubject() throws AkuraAppException {
    
        StudentTermMark newTermMark = studentTermMarkDaoRef.save(studentTermMark);
        assertNotNull("Student Term Mark type should not be null " + newTermMark);
        
        List<StudentTermMarkDTO> list =
                studentMarksViewDao.getTermMarksByClassInfoIdAndGradeSubject(studentClassInfo.getStudentClassInfoId(),
