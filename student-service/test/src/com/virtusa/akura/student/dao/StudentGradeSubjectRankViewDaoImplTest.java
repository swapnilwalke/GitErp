 ...
 */
public class StudentGradeSubjectRankViewDaoImplTest extends BaseStudentTest{
    ...
    /**
     * Test method for getStudentGradeSubjectRank method in StudentGradeSubjectRankViewDaoImpl.
     * 
     * @throws AkuraAppException if exception occurs
     */
    @Test
    public void testGetStudentGradeSubjectRank() throws AkuraAppException {
        ...
        List<StudentGradeSubjectRankView> list =
                studentGradeSubjectRankViewDao.getStudentGradeSubjectRank(gradeSubject.getGradeSubjectId(),
                        Integer.parseInt(DateUtil.getStringYear(studentClassInfo.getYear())), noOfPrizes);
        
        assertTrue(list.get(0).getTotal() == 10);
        assertTrue(list.get(0).getAverage() == 10);
    }
